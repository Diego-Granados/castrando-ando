...
export async function sendEmail(msg, correo, nombre, cedula) {
    ...
    try{
        ...
        smtpEmail.to = [
            {email: "braytonss2002@gmail.com", name: "Asociacion de Perritos Abandonados"}
        ];
        smtpEmail.textContent = "Utiliza el correo " + correo + " para comunicarte con " + nombre + ". Te envía este mensaje: " + msg;
