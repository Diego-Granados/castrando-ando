...
const VolunteersPage = () => {
    ...
    return (
        <div className="container">
            <h1>Voluntariado</h1>
            <p>Bienvenidos. Aquí puedes enviar tu información para ser parte del voluntariado de Castrando Ando.</p>

            <section style={{ padding: '20px' }}>
                <h2>Formulario de solicitud</h2>
                {submitted ? (
                    <p>Gracias por enviar tu información! nos estaremos comunicando contigo.</p>
                ) : (
